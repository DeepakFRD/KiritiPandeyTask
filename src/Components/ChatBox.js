...
import { Bell, Calendar, Check, ChevronDown, Circle, FileText, Grid, Image, LogOut, MessageCircle, Mic, MoreHorizontal, MoreVertical, Paperclip, Plus, Search, Settings, User } from 'react-feather'
    ...
    return (
        ...
        <Fragment>
            ...
            <Row style={{ maxHeight: "100vh" }}>
                <Col md={2}>
                    <Card className='Main_Chat_Card_Section shadow'  >
                        <div>
                        ...
                        <p className='mt-3'>Henry Jabbawockiez&nbsp;<ChevronDown size={18} /></p>
                        <div>
                            <h6 className='header_section'><Grid size={14} />&nbsp;&nbsp;Home</h6>
                ...
                <Col md={10} className=' head-section' style={{ maxHeight: "100vh", overflow: "hidden" }} >
                    <Row className='p-5 w-100'>
                        <Col md={5} style={{ maxHeight: "90vh", overflowY: "auto" }}>
                            ...
                            <div className='Events_Body_Top_section2 shadow'>
                                ...
                                <div className='Events_Menu2'>
                                    <p>Message&nbsp;&nbsp;<ChevronDown size={15} /></p>
                                </div>
                            </div>
                            {/* ==============Card Section===================== */}
                            <div className='Events_Body_Top_section3 mt-3 shadow rounded-2 p-1'>
                            ...
                            {/*============================ content section========================= */}
                            <div className='Events_Body_Top_section3 mt-3 shadow rounded-2 p-2'>
                                <div className='w-100 d-flex justify-content-between  align-items-center p-2'>
                                    <div className='Events_Menu3 d-flex align-items-center gap-2'>
                                        ...
                                        <div className='d-flex flex-column align-items-start'>
                                            <h5 className='luy mt-1'>Jared Sunn</h5>
                            ...
                            {/* ========================linear section=============== */}
                            <div className='Events_Body_Top_section4 mt-3 shadow rounded-2 p-2'>
                                <div className='w-100 d-flex justify-content-between  align-items-center p-2'>
                                    <div className='Events_Menu3 d-flex align-items-center gap-3'>
                                        <img src='https://s3-alpha-sig.figma.com/img/a989/fdc8/9c83b167b9782d670e311f9d9eb4e890?Expires=1685923200&Signature=ZFVfqY3UifpWUNMd0tkl6893ZyByhaKa8aVBFcZgjhCd3qhLCJFqXqT2h7aFCk7qZnM51GImm8cACBH3yIhi-wFvfpgaHgvbJzUZvDCij4TZKeYrMDk~Q5ExQnf6z9Yj-P87HR1Bxu49oBzt3G6u5Vdeh-C6qVZIR4dox8pcDig1r005z9IDZQObXCYaM1U8pDuXQCGZ7uit2yefucgjPSeV7AGBkMAzmrJ2MmUx04zvLJ3P20vvezces9OAHRT2cLqPE4XE6myyyLkDjlYHQewo3oKOe0lkRQ8avuaFyrMyDrt8btE0CcSXK~fX9I59BcZY5jeCnc6zLLJrz3HbFQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4' alt='' />
                                        <div className='d-flex flex-column align-items-start gap-1'>
                                            <h5 className='luy mt-1'>Nika Jerrardo</h5>
                            ...
                            {/*======================= last section==================== */}
                            <div className='w-100 d-flex justify-content-between  align-items-center p-2 shadow mt-3'>
                                <div className='Events_Menu3 d-flex align-items-center gap-3'>
                            ...
                            <Card className='w-100 shadow'>
                                <CardHeader className='d-flex align-items-center justify-content-between '>
                                    <div className="UserProfileCont d-flex align-items-center gap-2">
                                        ...
                                        <div className='d-flex flex-column  align-items-start justify-content-center'>
                                            <span>Nicholas Pooran</span>
                                            <span style={{ color: '#2A8BF2' }}>Last Seen 5 hours ago </span>
                                        </div>
                                    ...
                                    <div className='d-flex align-items-start justify-content-start gap-2 leftMsg' style={{ maxWidth: "70%" }}>
                                        ...
                                        <div>
                                            <div className="Msg d-flex flex-column align-items-start justify-content-start shadow position-relative">
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam enim nostrum earum aliquam commodi modi
                                ...
                                {/* =================footer section================== */}
                                <hr></hr>
                                <div className='Events_Body_Top_section2 '>
                                    <div className='Events_Menu2'>
                                        <p>Type a message here</p>
                                    </div>

                                    <div className='Events_Menu2 mt-2'>
                                        <img src='https://cdn-icons-png.flaticon.com/128/742/742751.png' alt='' className='smileIcon' />
                                    </div>
                                </div>
